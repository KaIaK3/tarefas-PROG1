/***************************************************************************
 *   quadrado.cpp                             Version 20231213.130258      *
 *                                                                         *
 *   Classe Quadrado derivada de Retangulo                                 *
...
/* ---------------------------------------------------------------------- */
/* class quadrado derivada de retangulo */
class quadrado : public retangulo
{
    private:
        int tam;
    public:
        quadrado(int q):retangulo(q, q) {};
};
...
int main(void)
{
    ...
    retangulo b(2,6); /* b inicia com tamanho 2,2 */
    quadrado r(2);
