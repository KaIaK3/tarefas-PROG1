...
/* Problem description: encontrar a diferença entre a soma dos quadrados e os quadrados da soma dos 100 primeiros numeros.
 *
 */
...
void pe6(void)
{
    ...
    x = 1;
    somadosquadrados = quadradodasoma = r = 0;
    ...
    r = quadradodasoma - somadosquadrados;
